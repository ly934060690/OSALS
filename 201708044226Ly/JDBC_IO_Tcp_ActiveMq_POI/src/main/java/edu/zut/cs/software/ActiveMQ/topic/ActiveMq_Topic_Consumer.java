...
public class ActiveMq_Topic_Consumer {
    ...
    public class Consumer implements Runnable {
        ActiverMq_Topic_Consumer_Demo activerMq_topic_consumer_demo;
        String TopicName;

        public Consumer(ActiverMq_Topic_Consumer_Demo activerMq_topic_consumer_demo, String topicName) {
