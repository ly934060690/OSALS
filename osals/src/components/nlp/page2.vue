<template>
  <div>
    ...
    <h1 style="line-height:2px">*****:<input type="text"  class="qxs-ic_password qxs-icon"  v-bind:value="data" style="width: 500px ; height: 25px"></h1>
...
<script type="text/javascript">
  ...
  export default {
    ...
    methods:{
      test1:function () {
        let that = this
        var url = this.HOST+"/stu/response"
