...
alter table T_CAR
	drop foreign key FKmeeqyc4dqwfito7vubtccs9ue;
...
alter table T_DRIVER
	drop foreign key FK35xq3wpt2vb9ij5ml6x9ovew2;

alter table T_ENWRAP
	drop foreign key FKq7wscx0pkac5mxyho3ujqwev4;

alter table T_EXPRESSCAR
	drop foreign key FKojoqptrp5insa526nhu4b67ob;
...
drop table if exists T_ENWRAP;

drop table if exists T_EXPRESSCAR;
