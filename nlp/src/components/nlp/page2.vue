  ...
  <div>
    ...
    <h1 style="line-height:8px">
      <h style="position: relative; left: -50px">
        ...
        <textarea  class="textarea1" v-bind:value="data.hanLP"></textarea></h>

      <h style="position: relative; right: -50px">
        <textarea  class="textarea2" v-bind:value="data.stanford" ></textarea></h>

    </h1>
    <h1 style="line-height:8px">
      <h style="position: relative; left:  -50px">
        <p style="line-height:0px ; position:relative; left:30px ; white-space:pre">StanfordNlp                                                                                                  AnsjNlp</p>
        <textarea  class="textarea3" v-bind:value="data.stanford" ></textarea></h>

      <h style="position: relative; right: -50px">
        <textarea  class="textarea4" v-bind:value="data.hanLP" ></textarea></h>
    </h1>
...
<script type="text/javascript">
  ...
  export default {
    ...
    methods:{
      test1:function () {
        let that = this
        var url = this.HOST+"/nlperg/response"
