  ...
  <el-table
    ...
    <el-table-column label="操作">
      <template slot-scope="scope">
        ...
        <el-dialog title="快递车" :visible.sync="dialogFormVisible">
          <el-form :model="Form">
...
<script>
  export default {
    ...
    methods: {
      ...
      postForm() {
        const url = this.HOST + '/expressCar/save';
      ...
      handleDelete(index, row) {
        ...
        console.log(Id);
        this.$axios
          .delete(this.HOST + '/expressCar/delete/' + Id)
          .then(res => {
            console.log(res);
    ...
    created() {
      this.$axios.get(this.HOST+'/expressCar/all')
        .then(response=>{
