  ...
  <el-table
    ...
    <el-table-column label="操作">
      <template slot-scope="scope">
        ...
        <el-dialog title="快递公司" :visible.sync="dialogFormVisible">
          <el-form :model="Form">
...
<script>
  export default {
    ...
    methods: {
      ...
      postForm() {
        const url = this.HOST + '/courierCompany/save';
        this.dialogFormVisible = false;
        var params = new URLSearchParams();
        params.append('housename', this.Form.housename);
      ...
      handleDelete(index, row) {
        ...
        console.log(Id);
        this.$axios
          .delete(this.HOST + '/courierCompany/delete/' + Id)
          .then(res => {
            console.log(res);
    ...
    created() {
      this.$axios.get(this.HOST+'/courierCompany/all')
        .then(response=>{
